window.CONFIG = {
  crawl: `JibboshTV is available on a bunch of platforms! check it out at https://publictelevision.jibbosh.com/watch`,
  greeting: 'This is your weather',
  language: 'en-CA', // Supported in TWC API
  countryCode: 'CA', // Supported in TWC API (for postal key)
